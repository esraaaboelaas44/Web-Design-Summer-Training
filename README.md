# NTI Web Design Summer Training
...
### Tasks
Individual assignments demonstrating mastery of specific concepts:
...
1. Clone this repository:
   ```bash
   git clone https://github.com/esraaaboelaas44/Web-Design-Summer-Training.git
   ```

2. Navigate to the project folder:
   ```bash
   cd Web-Design-Summer-Training
   ```
